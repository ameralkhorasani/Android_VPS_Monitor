...
interface ServerDao {
    ...
    @Query("UPDATE servers SET codeServerPort = :port, encryptedCodeServerPassword = :encryptedPassword WHERE id = :id")
    suspend fun updateCodeServerConfig(id: String, port: Int, encryptedPassword: String?)
