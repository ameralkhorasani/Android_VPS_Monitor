...
class SshRepository @Inject constructor(
    ...
    /**
     * Starts sshj's heartbeat, which keeps idle sessions (notably a port forward left
     * running in the background) from being dropped by NAT and firewall timeouts.
     *
