...
> [Report a vulnerability](https://github.com/ameralkhorasani/Android_VPS_Terminal/security/advisories/new)
...
- **Tunnelled services stay private** — `code-server` binds to the server's loopback
  interface and is reached only through the SSH tunnel.
